...
The workflows should now succeed and you will be able to find the code coverage at this link: `https://app.codecov.io/gh/your-username/{{cookiecutter.project_name}}`. You might have to wait couple of minutes and the coverage of this repository should be ~60%.
